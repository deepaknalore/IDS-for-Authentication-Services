...
print('Number of blocked %: ' + str(blocked/(total_users) * 100))
print('Number of successful breaches: ' + str(sucessfulBreach/(total_users) * 100))
print('Number of failed auths: ' + str(failedAuth/(total_users) * 100))
